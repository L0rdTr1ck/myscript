...
#
#  Copyright L0rdtr1ck <lordtrick123@gmail.com>
#
...
iptables -A INPUT -p tcp --dport=22 -j LOG --log-level warning --log-prefix "[firewall] [ssh-default]"
iptables -A INPUT -p udp --dport=22 -j LOG --log-level warning --log-prefix "[firewall] [ssh-default]"
iptables -A INPUT -p tcp --dport=3322  -j LOG --log-level warning --log-prefix "[firewall] [ssh-lordtrick]"
iptables -A INPUT -p tcp --dport=40056 -j LOG --log-level warning --log-prefix "[firewall] [TeamServer]"
iptables -A INPUT -p udp --dport=3322 -j LOG --log-level warning --log-prefix "[firewall] [ssh-lordtrick]"
...
iptables -A INPUT -p tcp -m multiport --dport 3322,40056 -j ACCEPT
...
echo "|                    .-.      .-.                                  |"
echo "|                   /            \                                 |"
echo -e "|                  | [\033[01;32m L0RDTR1CK \033[01;31m] |                                |"
echo "|                  |,  .-.  .-.  ,|                                |"
echo "|                  | )(|_/  \|_)( |                                |"
echo "|                  |/     /\     \|                                |"
echo "|          _       (_     ^^     _)                                |"
